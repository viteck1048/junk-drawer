...
# this directory: ./traub and ./sniff.
#
...
# directory: the installer gets run from wherever (sh /media/usb/traub/install.sh)
...
print("syntax OK on python " + ".".join(map(str, sys.version_info[:3])))' "$HERE/traub" "$HERE/sniff"
...
echo "then list the serial ports with:   $HERE/traub ports"
