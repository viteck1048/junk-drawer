...
# directory: the installer gets run from wherever (sh /media/usb/ct161/install.sh)
...
print("syntax OK on python " + ".".join(map(str, sys.version_info[:3])))' "$HERE/sniff"
...
echo "then list the serial ports with:   $HERE/sniff --ports"
