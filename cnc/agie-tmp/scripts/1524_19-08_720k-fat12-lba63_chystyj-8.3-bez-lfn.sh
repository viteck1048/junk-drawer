...
IMG="$IMGDIR/720k-lba63-chysty_$(date +%Y%m%d-%H%M%S).img"
...
if long_files:
    ...
    for n, _, sz, _, _ in long_files:
        print("            %-40s %d Б" % (n, sz))
    print()
print("записів LFN у томі: 0. Затички проти вінди немає.")
print("У корені лише мітка тому і %d файлів 8.3 — розбирати нема чого." % len(log_short))
PYEOF
